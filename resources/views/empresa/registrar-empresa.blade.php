...
<div class="card card-warning">
    ...
    <form class="formularioempresa" id="formularioempresa" action="{{ url('/guardar-empresa') }}" method="POST">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-4 enterprice-ruc">
                    <input type="number" class="form-control" name="ruc" placeholder="RUC" oninput="this.value = this.value.toUpperCase();" style="text-transform: uppercase;margin-bottom: 15px;" autocomplete="off">
                </div>
                <div class="col-4 enterprice-social">
                    <input type="text" class="form-control" name="razon" placeholder="RAZON SOCIAL" oninput="this.value = this.value.toUpperCase();" style="text-transform: uppercase;margin-bottom: 15px;" autocomplete="off">
                </div>
                <div class="col-4 enterprice-direction">
                    <input type="text" class="form-control" name="direccion" placeholder="DIRECCION" oninput="this.value = this.value.toUpperCase();" style="text-transform: uppercase;margin-bottom: 15px;" autocomplete="off">
                </div>
            </div>
        </div>
