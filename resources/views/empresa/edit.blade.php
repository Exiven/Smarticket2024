                    ...
                    <thead>
                      ...
                      <tr>
                        <form  method="POST" action="{{ route('empresa.update', $empresas->id) }}">
                            ...
                            <td><input oninput="this.value = this.value.toUpperCase();" style="text-transform: uppercase;" type="text" name="razon" value="{{ $empresas->nom_empresa }}"></td>
                            <td><input type="number" name="ruc" value="{{ $empresas->ruc_empresa }}"></td>
                            <td><input oninput="this.value = this.value.toUpperCase();" style="text-transform: uppercase;" type="text" name="direccion" value="{{ $empresas->dir_empresa }}"></td>
