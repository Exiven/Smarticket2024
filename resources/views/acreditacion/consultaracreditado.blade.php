  ...
  <div class="row align-items-end list">
      ...
      <div class="col-sm-5 col-md-6">
          ...
          <form method="GET" action="{{ url('/validar') }}">
            ...
            <input type="text" name="dni" value="{{ $dni}}" class="form-control" id="dni" oninput="this.value = this.value.toUpperCase();" style="text-transform: uppercase;margin-bottom: 10px;" placeholder="77777777 | XXXXX00000" autocomplete="off">
