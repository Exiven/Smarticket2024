...
<div class="card card-danger">
    ...
    <form class="formularioevento" id="formularioevento" action="{{ url('/guardar-evento') }}" method="POST">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-2">
                    <select name="empresa" class="form-control" oninput="this.value = this.value.toUpperCase();" style="text-transform: uppercase;margin-bottom: 15px;">
                ...
                <div class="col-2">
                  <select name="tip_evento" class="form-control" style="margin-bottom: 15px;">
                ...
                <div class="col-3">
                    <input type="text" name="nom_evento" class="form-control" placeholder="NOMBRE DE EVENTO" oninput="this.value = this.value.toUpperCase();" style="margin-bottom: 15px;" autocomplete="off">
                </div>
                <div class="col-3">
                    <input type="text" name="lug_evento" class="form-control" placeholder="LUGAR DE EVENTO" oninput="this.value = this.value.toUpperCase();" style="margin-bottom: 15px;" autocomplete="off">
                </div>
                <div class="col-2">
                    <input type="text" id="fecha_env" name="fecha_env" class="form-control" placeholder="FECHA DE EVENTO" autocomplete="off" style="margin-bottom: 15px;" autocomplete="off">
                  </div>
            </div>
        </div>
...
jQuery(document).ready(function($) {
  $("#fecha_env").datepicker({ dateFormat: 'yy-mm-dd', minDate: 0});
