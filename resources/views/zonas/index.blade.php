        ...
        <form  action="{{ url('/guardar-zona') }}" method="POST">
          ...
          <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-5">
                  <input type="text" class="form-control" name="nom_zona" placeholder="NOMBRE DE ZONA" oninput="this.value = this.value.toUpperCase();" style="text-transform: uppercase;margin-bottom: 10px;">
                  </div>
                  <div class="col-4">
                  <input type="number" class="form-control" name="aforo" placeholder="N° DE AFORO" oninput="this.value = this.value.toUpperCase();" style="text-transform: uppercase;margin-bottom: 10px;">
                  </div>
                  <div class="col-3">
